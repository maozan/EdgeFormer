...
def get_args():
    ...
    parser.add_argument('--project_name', default='edm_cgm_fm', type=str)
    parser.add_argument('--gpu_ids', type=str, default='1', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default='./checkpoints/', type=str)
    parser.add_argument('--output_folder', default='samples_LEVIR/predict_CD_edgeformer', type=str)

    # data
    parser.add_argument('--num_workers', default=0, type=int)
    parser.add_argument('--dataset', default='CDDataset_edge', type=str)
    ...
    parser.add_argument('--net_G', default='edm_cgm_fm', type=str,
